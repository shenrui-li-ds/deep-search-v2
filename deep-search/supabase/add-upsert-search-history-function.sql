...
BEGIN
  ...
  ELSE
    ...
    INSERT INTO public.search_history (user_id, query, provider, mode, sources_count, refined_query)
    VALUES (p_user_id, p_query, p_provider, p_mode, p_sources_count, p_refined_query)
    RETURNING * INTO v_result;
  END IF;
